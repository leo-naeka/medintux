/****************************************************************************
** $Id: CFtp.h,v 1.1.1.1 2005/07/16 14:29:33 medintux Exp $
**
** Definition of CFtp class.
**
** Created : 970521
**
...
*/
#ifndef QM_EXPORT_FTP
   #define QM_EXPORT_FTP
#endif
class QSocket;
class CFtpCommand;

class QM_EXPORT_FTP CFtp : public QNetworkProtocol
{
    Q_OBJECT

public:
    CFtp(); // ### Qt 4.0: get rid of this overload
    CFtp( QObject *parent, const char *name=0 );
    virtual ~CFtp();
