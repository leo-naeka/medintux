  ...
  if (!isDayExpand())
    ...
    { //............. on note la hauteur actuelle .................................
      ...
      if (actualHeight!=m_Height)
         ...
         {update();      // si hauteur non modifiée il n'y a juste qu'a raffraichir l'affichage
         }
    }
}
...
{     // ne pas looker c'est fait avant l'appel
    ...
    m_cacheRDV_List.appendRdv(pC_RendezVous);    // donc on l'ajoute donc simplement à la liste et ca le fait
