...
//
#include "C_PatientBase_Var.h"
#define   SKIP_BLANK_CAR(a)        while( *(a) && (*(a)==' ' || *(a)=='\t' || *(a)== 96) ) (a)++
#define   NEXT_LINE(a)             while( *(a) && *(a)!='\r' && *(a)!='\n')(a)++; while( *(a) && (*(a)=='\r'|| *(a)=='\n'))(a)++

//-----------------------------------------------------  C_PatientBase_Var -------------------------------------------
C_PatientBase_Var::C_PatientBase_Var(  const QString& confData, QString *errMess)
...
//-----------------------------------------------------  SetConfBase -------------------------------------------
int C_PatientBase_Var::initValues(  const QString& confData, QString *errMess)
...
char  *C_PatientBase_Var::SetConfBase_SetProperties(char *pt, QString &propertie, const char *token, int *line , QString &err)
{int nLine      = *line;
    err            = "";
