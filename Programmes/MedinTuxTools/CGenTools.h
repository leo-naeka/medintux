...
class CGenTools
{
 ...
 CGenTools(){};
~CGenTools(){};
static       QString      resolvePath(QString pathFile, const QString &pathAppli, const QString &pathGlossaire);
static       QString      resolvePathKeyWord(QString pathFile, const QString &pathAppli, const QString &pathGlossaire);
static       int          DialogGetString(QWidget * parent, const char* title, QString &string, int x=0, int y=0);
static       int          DialogGetString(QString message, QWidget * parent, const char* title, QString &string, QString mimeSourceFactoryPath  = QString::null , int x =0, int y =0);
static       int          MessageAlert(QWidget * parent, const char* title, const char* message=0, const char* button1=0, const char* button2=0,const char* button3=0,const char* button4=0, int w = -1, int h = -1, const QString &mimeSourceFactoryPath="");
...
static       QString      get_FamilleGenreClasse( const QString &familleGenre, const QString &code );
//......................................... DATA ...............................................
