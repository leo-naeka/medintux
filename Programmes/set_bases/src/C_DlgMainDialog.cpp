...
{   pushButton_SetBases->hide();
   ...
   //............................ QT4 QT4 QT4 QT4 QT4 QT4 QT4 QT4 QT4 ........................................................
       ...
       {if (isQT4Here)
        ...
        #endif
        #ifdef Q_WS_WIN
            CGestIni::Param_UpdateToDisk(G_pCApp->m_PathAppli+"makeModuleQt4.bat", script);
            system(G_pCApp->m_PathAppli+"makeModuleQt4.bat");
            updateExit();
        #else
...
void C_DlgMainDialog::setBase(const QString &sqlFile /* = "" */)
{
   ...
   port     = lineEdit_Sql_Port->text().stripWhiteSpace();
    ...
    if (ret==1) pushButton_MajBases_clicked();
    else if (ret==2)
        {tabWidget_Instal->setTabEnabled ( m_pTabQWidgetBases,  FALSE );
         tabWidget_Instal->setTabEnabled ( m_pTabQWidgetTherap, FALSE );
...
//----------------------------------------- GetListBasesInMySql ------------------------------------------------
QStringList C_DlgMainDialog::GetListBasesInMySql(QString *err)
{       //.................. lire le fichier ini pour en retirer les paramêtres de connexion ...............
   ...
   if (!mysql_base->isOpen())
    ...
    err = tr("Erreur GetListBasesInMySql()");
    QStringList basesList;
    QString path = CGestIni::Construct_Name_Exe("mise_a_jour",QFileInfo (qApp->argv()[0]).dirPath (true));
    basesList.clear();
    QProcess  proc( this );
    proc.addArgument( path );
    proc.addArgument("GetBasesList");
    if ( proc.start() )
    {qApp->processEvents ();
        QTimer timer;               // pour etre sur qu'un evenement se produise
        timer.start(100, FALSE);    // sinon boucle sans fin dans    processEvents ( QEventLoop::WaitForMore )
    ...
    if (val.length()!=0)
       {if (val.left(6)==tr("Erreur"))  err = val;
        else                           {basesList = QStringList::split("|",val); err = "";}
       }
      return basesList;
    */
}
...
{   //................... lancer process ......................................
    ...
    QString pathDest = CGestIni::Construct_PathBin_Module("qgetdatasemp", qfi.dirPath (true));
    ...
    QString pathExe = CGestIni::Construct_Name_Exe("qgetdatasemp", QFileInfo (qApp->argv()[0]).dirPath (true));
    QProcess proc5(this);
