...
{   //............................. variables permettant la reinitialisation du dialogue ................
    ...
    //>>>>>>>............ forme particuli�e des nouvelles rubriques �venir o ..................................
    //                    le libelle du document d'entete et de pied de page doit �re
    //                    de la forme : [NOM DE LA RUBRIQUE] LIBELLE DE LA RUBRIQUE (avec le # ou * et eventuels pr�ixages)
      {
    ...
    if (posDebBloc != -1 && posEndBloc != -1)
       {
        ...
        if (end != -1)
           {toInsertAfter     = m_HeadText.mid(deb,end-deb);                               // recuperer la chaine du corps apres laquelle il faut inserer
            ...
            QString toInsert  = m_HeadText.mid(deb,posEndBloc-deb);                        // recuperer la chaine � inserer
...
{   UPDATE_USER_PARAM( &USER_PARAM, m_SignUser);    // sauvegarder les parametres de l'utilisateur DrTUX au cas ou l'user dont
    ...
    QString param          = m_pCMoteurBase->ReadDrTuxUserParametres(m_SignUser );   // lecture directe dans la base de donn� pour modifier ensuite
