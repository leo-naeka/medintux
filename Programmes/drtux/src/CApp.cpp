...
static char NUM_VERSION[]     = "==##@@==2.16.003==@@##==";
//--------------------------------------------- CApp -------------------------------------------------------------------
CApp::~CApp()
{
...
{QString insertMask = "";
 ...
 if (insertMask.length()==0) // si pas de masque valide on insère une référence simple par défaut.
    { if (pos != -1)
      ...
      return (QString("<img src=\"") + imgName + toScale  + "><br>");
    }
   ...
   switch(optionNumber)
     {case 1:{
      ...
      case 6:
              ...
              //............ creer ................
              if (optionNumber == 5)
                 {html = makeData(fileName, 400, 500, maxImageWidth ,m_PathAppli + "Ressources/RubriquesTextes/ImageMaskSTD.html");
