 ...
 */
 ...
 //......................... completer les autres arguments .........................................
    ...
    //proc.addArgument( pathExe + ".app/Contents/MacOS/" + QFileInfo(pathExe).baseName() );                   // 0  Chemin de l'executable plugin à actionner
    //qDebug( pathExe + ".app/Contents/MacOs/" + QFileInfo(pathExe).baseName());
 #else
    str = pathExe + F_EXT;
    //proc.addArgument( pathExe+F_EXT );                   // 0  Chemin de l'executable plugin à actionner
 #endif
 proc.addArgument( str );
 if ( !QFile::exists( str ) )
