...
{textBrowser_Prescription->mimeSourceFactory()->addFilePath (G_pCApp->m_PathImages  + "ImgVidalDgl" );
 textBrowser_Posologies->mimeSourceFactory()->addFilePath (G_pCApp->m_PathImages    + "ImgVidalDgl" );
 textBrowser_Monographie->mimeSourceFactory()->addFilePath (G_pCApp->m_PathImages   + "ImgVidalDgl" );
}
//------------------------------------------- initDialog -------------------------------------------------------------------------------
...
{int ret;
 ...
 if ( (ret=initDialog( pCMedBase )) ==0) return 0;
...
{if (pCMedBase == 0) return 0;
 ...
 textBrowser_Prescription->mimeSourceFactory()->setFilePath (G_pCApp->m_PathImages + "ImgVidalDgl" );
 textBrowser_Posologies->mimeSourceFactory()->setFilePath (G_pCApp->m_PathImages   + "ImgVidalDgl" );
 textBrowser_Monographie->mimeSourceFactory()->setFilePath (G_pCApp->m_PathImages  + "ImgVidalDgl" );
 //................. ameliorer les fonds ....................................................
 QString path_image = G_pCApp->m_PathAppli + "/Ressources/ImgVidalDgl/";
 QPixmap image;
 image.load (path_image+"CuirMaron.png");
 textBrowser_Monographie->setPaletteBackgroundPixmap (image);
 image.load (path_image+"bois bleu.png");
 textBrowser_Posologies->setPaletteBackgroundPixmap (image );
 image.load (path_image+"granit bleu.png");
 textBrowser_Prescription->setPaletteBackgroundPixmap (image );
 pushButtonByReferent->setIconSet  ( QIconSet (QPixmap(G_pCApp->m_PathAppli + "/Ressources/ImgVidalDgl/referent.png"))) ;
 pushButtonByGenerique->setIconSet ( QIconSet (QPixmap(G_pCApp->m_PathAppli + "/Ressources/ImgVidalDgl/generiques.png"))) ;
 pushButtonByPrincipe->setIconSet  ( QIconSet (QPixmap(G_pCApp->m_PathAppli + "/Ressources/ImgVidalDgl/BySubstance.png"))) ;
 pushButtonByObsolete->setIconSet  ( QIconSet (QPixmap(G_pCApp->m_PathAppli + "/Ressources/ImgVidalDgl/supprimes.png"))) ;
 pushButtonByStandard->setIconSet  ( QIconSet (QPixmap(G_pCApp->m_PathAppli + "/Ressources/ImgVidalDgl/standards.png"))) ;
#ifdef Q_OS_MACX
 pushButtonByReferent->setFlat(TRUE);
 pushButtonByGenerique->setFlat(TRUE);
 pushButtonByPrincipe->setFlat(TRUE);
 pushButtonByObsolete->setFlat(TRUE);
 pushButtonByStandard->setFlat(TRUE);
#endif 
 //.............................. le logo ...............................................................
 if ( (int)(m_pCMedBase->Medica_GetBaseMode() & CMedicaBase::Datasemp) )
    {
     image.load (path_image+"DataSempLogo.png");
    }
 else
    {image.load (path_image+"LogoMachin.png");
 ...
 if (id != -1)
    {image.load (path_image+"logo_vidal_petit.png");
...
{m_CurrentPopupItem = "";
 ...
 m_pQPopupMenu      = new QPopupMenu(this, "MyPopupMenu" );
...
{int     pos(0);
 ...
 //...................................................... ajout d'un produit medicamenteux ..................................................
    ...
    {QString spoids  = QString::number( m_pCMedBase->Medica_ExtractNumber( textLabel_Poids->text()));
     ...
     Dlg_MedicaAdjustPoso* dlg = new Dlg_MedicaAdjustPoso(this, "AdjustPoso", TRUE);
     if (dlg==0)                   return;
     int pos = link.find("==");
     if (pos==-1)                  return;
     //page += "<br><b>1)<a href=\"#PosoText"+ cip + "==" + QString::number(tableIndex) + "\"> Pas de données sur la posologie, les préciser textuellement</b></a></span>";
     ...
     */
     ...
     Dlg_PosoManager *dlg = new Dlg_PosoManager(this, "ManagerPoso", TRUE);
     if (dlg==0)                   return;
...
{int              pos_deb;
 ...
 switch(action_typ )
  {case 'U':
       {
        DlgGetText  *dlg = new DlgGetText(this,"GetText_Dial",TRUE);
        if (dlg ==0)          return;
        tmpQStr = m_CPosologieOrdoList[num].m_PosoTextuelle;
        tmpQStr.replace("<br />", "\n");
        dlg->textEdit->setText(tmpQStr);
        if (dlg->exec()  == QDialog::Accepted)
           {Convert_CRLF_To_BR(dlg->textEdit->text(), m_CPosologieOrdoList[num].m_PosoTextuelle, 1);
           }
        delete dlg;
           ...
           {DlgGetText  *dlg = new DlgGetText(this,"GetText_Dial",TRUE);
            if (dlg !=0)
               {tmpQStr = m_CPosologieOrdoList[num].m_PosoTextuelle;
                tmpQStr.replace("<br />", "\n");
                dlg->textEdit->setText(tmpQStr);
                if (dlg->exec()  == QDialog::Accepted && dlg->textEdit->text() !="")
                   {Convert_CRLF_To_BR(dlg->textEdit->text(), m_CPosologieOrdoList[num].m_PosoTextuelle, 1);
                    m_CPosologieOrdoList[num].m_PosoType       |=  (int)CPosologie::Textuelle;
                   }
                else
