...
{   setTextFormat(Qt::RichText);
    ...
    if (m_PathGlossaire.length())  mimeSourceFactory()->addFilePath(m_PathGlossaire + "/ImagesFolder");
...
void MyEditText::PopupItemAddItem ()
{
 ...
 QString pathImg    = m_PathAppli + "QLightPadSys";
 ...
 QString  path  = m_PathGlossaire  + INSERTION_ROOT; // = G_pCDrTuxApp->m_PathGlossaire + INSERTION_ROOT + QDir::separator() + GetPathItem (m_pQListViewItem);
...
{//.................. recuperer position de depart .............................................
 ...
 m_LastFont  = currentFont();            //relever la police de caract�e �l'endroit de l'insertion
 m_LastColor = color();
...
//-------------------------------------------------- specialInsert -----------------------------------------------------------------
// ACTION Insere un texte html en ne conservant que les retours chariot, tabulations et la couleur bleue des menus deroulants
//         le reste du style du texte est celui de l'endroit ou le texte est insere
//
