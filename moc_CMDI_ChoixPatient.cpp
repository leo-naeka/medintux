/****************************************************************************
** CMDI_ChoixPatient meta object code from reading C++ file 'CMDI_ChoixPatient.h'
**
** Created: Wed May 4 22:20:25 2011
...
const char *CMDI_ChoixPatient::className() const
{
    return "CMDI_ChoixPatient";
}

QMetaObject *CMDI_ChoixPatient::metaObj = 0;
static QMetaObjectCleanUp cleanUp_CMDI_ChoixPatient( "CMDI_ChoixPatient", &CMDI_ChoixPatient::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString CMDI_ChoixPatient::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "CMDI_ChoixPatient", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString CMDI_ChoixPatient::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "CMDI_ChoixPatient", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* CMDI_ChoixPatient::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	"CMDI_ChoixPatient", parentObject,
	slot_tbl, 2,
	signal_tbl, 2,
	...
	0, 0 );
    cleanUp_CMDI_ChoixPatient.setMetaObject( metaObj );
    return metaObj;
}

void* CMDI_ChoixPatient::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "CMDI_ChoixPatient" ) )
	return this;
...
// SIGNAL message
void CMDI_ChoixPatient::message( const QString& t0, int t1 )
{
    if ( signalsBlocked() )
	return;
...
void CMDI_ChoixPatient::Sign_RubIsDeleted( const char* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool CMDI_ChoixPatient::qt_invoke( int _id, QUObject* _o )
{
...
bool CMDI_ChoixPatient::qt_emit( int _id, QUObject* _o )
{
...
bool CMDI_ChoixPatient::qt_property( int id, int f, QVariant* v)
{
    return CMDI_Generic::qt_property( id, f, v);
}

bool CMDI_ChoixPatient::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
