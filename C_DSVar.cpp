...
//-----------------------------------------------------  C_DSVar -------------------------------------------
C_DSVar::C_DSVar(  QString& confData)
{m_LastError             = "";
...
//-----------------------------------------------------  SetConfBase -------------------------------------------
int C_DSVar::initValues( QString& confData)
...
char  *C_DSVar::SetConfBase_SetProperties(char *pt, QString &propertie, const char *token, int *line , QString &err)
{int nLine      = *line;
 err            = "";
 ...
 err  = TR("\nErreur de syntaxe : C_DSVar::SetConfBase_SetProperties()"
