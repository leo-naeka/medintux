...
public:
   ...
   int                 StringDateNaturalToQDateTime(const QString &str_in, QDateTime & qdt_out);
   long                HeureMinuteSeconde_To_Val(const char* heure_in);
public:
...
private:
   PRT_LIST_CMetaField          *m_pCMetaFieldList;         // peut etre à zero lors de nouveaux documents dans liste et non enregistrés
